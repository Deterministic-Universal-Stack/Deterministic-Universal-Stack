...
} from "../apps/collab/src/shared.js";
...
describe("collaborative html room reducer", () => {
  ...
  it("normalizes GitHub blob URLs into raw content URLs", () => {
    expect(
      normalizeGitHubContentUrl("https://github.com/acme/site/blob/main/index.html")
    ).toBe("https://raw.githubusercontent.com/acme/site/main/index.html");
  });
});
