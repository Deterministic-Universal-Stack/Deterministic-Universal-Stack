import { compareEventIds } from "@dus/core";
import { jaccardDistance } from "@dus/math";
export function toReplicaView(nodeId, runtime) {
    return {
        nodeId,
...
export function gossipPair(left, right) {
...
export function convergeReplicas(replicas, maxRounds = 10) {
    const metrics = [];
